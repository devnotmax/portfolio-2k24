...
//       <div className="flex w-[330.58px] h-auto ">
...
//             <button className="border-2 border-[#C778DD] p-2 text-sm hover:border-white hover:text-[#C778DD] justify-center items-center">
//               <a href="{live}">Live <i className='bx bx-subdirectory-right'></i></a>
//             </button>
//             <button className="border-2 border-white p-2 text-sm hover:border-white hover:text-[#C778DD] justify-center items-center">
//               <a href="{github}">
    ...
    <div className="flex w-full mt-10">
      <div className="flex w-[330.58px] h-auto">
        <div className="text-white font-fira-code font-medium min-h-[400px] flex flex-col items-center border-[1px] border-white">
          ...
          <div className="flex mt-2 w-full px-2 justify-start gap-4">
